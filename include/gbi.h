...
#define G_RM_ADD                      (IM_RD|CVG_DST_SAVE|ZMODE_OPA|          \
                                       FORCE_BL|                              \
                                       GBL_c1(G_BL_CLR_IN,G_BL_A_FOG,         \
                                              G_BL_CLR_MEM,G_BL_1))
#define G_RM_ADD2                     (IM_RD|CVG_DST_SAVE|ZMODE_OPA|          \
                                       FORCE_BL|                              \
                                       GBL_c2(G_BL_CLR_IN,G_BL_A_FOG,         \
                                              G_BL_CLR_MEM,G_BL_1))
...
gsDPScisFillRectangle(ulx,uly,lrx,  \
                      lry)            gsDPFillRectangle((ulx)<0?0:(ulx),      \
                                                        (uly)<0?0:(uly),      \
                                                        (lrx)<0?0:(lrx),      \
                                                        (lry)<0?0:(lry))
...
gsDPSetHilite1Tile(tile,hilite,     \
                   width,height)      gsDPSetTileSize(tile,                   \
                                                      ((Hilite*)(hilite))->   \
                                                      h.x1&0xFFF,             \
                                                      ((Hilite*)(hilite))->   \
                                                      h.y1&0xFFF,             \
...
gsDPSetHilite2Tile(tile,hilite,     \
                   width,height)      gsDPSetTileSize(tile,                   \
                                                      ...
                                                      (((height)-1)*4+        \
                                                       ((Hilite*)(hilite))->  \
                                                       h.y2)&0xFFF)
#define gsDPSetAlphaCompare(mode)     gsSPSetOtherModeLo(G_MDSFT_ALPHACOMPARE,\
                                                         G_MDSIZ_ALPHACOMPARE,\
                                                         mode)
#define gsDPSetAlphaDither(type)      gsSPSetOtherModeHi(G_MDSFT_ALPHADITHER, \
                                                         G_MDSIZ_ALPHADITHER, \
                                                         type)
#define gsDPSetColorDither(type)      gsSPSetOtherModeHi(G_MDSFT_RGBDITHER,   \
                                                         G_MDSIZ_RGBDITHER,   \
                                                         type)
...
#define gsDPSetTextureConvert(type)   gsSPSetOtherModeHi(G_MDSFT_TEXTCONV,    \
                                                         G_MDSIZ_TEXTCONV,    \
                                                         type)
#define gsDPSetCycleType(type)        gsSPSetOtherModeHi(G_MDSFT_CYCLETYPE,   \
                                                         G_MDSIZ_CYCLETYPE,   \
                                                         type)
#define gsDPSetDepthSource(source)    gsSPSetOtherModeLo(G_MDSFT_ZSRCSEL,     \
                                                         G_MDSIZ_ZSRCSEL,     \
                                                         source)
#define gsDPSetCombineKey(type)       gsSPSetOtherModeHi(G_MDSFT_COMBKEY,     \
                                                         G_MDSIZ_COMBKEY,     \
                                                         type)
...
#define gsDPSetTextureDetail(type)    gsSPSetOtherModeHi(G_MDSFT_TEXTDETAIL,  \
                                                         G_MDSIZ_TEXTDETAIL,  \
                                                         type)
#define gsDPSetTextureFilter(mode)    gsSPSetOtherModeHi(G_MDSFT_TEXTFILT,    \
                                                         G_MDSIZ_TEXTFILT,    \
                                                         mode)
#define gsDPSetTextureLOD(mode)       gsSPSetOtherModeHi(G_MDSFT_TEXTLOD,     \
                                                         G_MDSIZ_TEXTLOD,     \
                                                         mode)
#define gsDPSetTextureLUT(mode)       gsSPSetOtherModeHi(G_MDSFT_TEXTLUT,     \
                                                         G_MDSIZ_TEXTLUT,     \
                                                         mode)
#define gsDPSetTexturePersp(enable)   gsSPSetOtherModeHi(G_MDSFT_TEXTPERSP,   \
                                                         G_MDSIZ_TEXTPERSP,   \
                                                         enable)
#define                             \
gsDPSetTile(fmt,siz,line,tmem,      \
...
#define gsSPClipRatio(r)              gsMoveWd(G_MW_CLIP,G_MWO_CLIP_RNX,      \
                                      ...
                                      gsMoveWd(G_MW_CLIP,G_MWO_CLIP_RNY,      \
                                               (uint16_t)(r)),                \
                                      gsMoveWd(G_MW_CLIP,G_MWO_CLIP_RPX,      \
                                               (uint16_t)-(r)),               \
...
gsSPScisTextureRectangle(ulx,uly,   \
                         lrx,lry,   \
                         tile,s,t,  \
                         dsdx,dtdy)   gsTexRect((ulx)<0?0:(ulx),              \
                                                (uly)<0?0:(uly),              \
                                                (lrx)<0?0:(lrx),              \
                                                (lry)<0?0:(lry),              \
                                                tile),                        \
...
gsTexRect(ulx,uly,lrx,lry,tile)       gO_(G_TEXRECT,                          \
                                          ...
                                          gF_(uly,12,0))
#define                             \
gsTexRectFlip(ulx,uly,lrx,lry,tile)   gO_(G_TEXRECTFLIP,                      \
                                          gF_(lrx,12,12)|gF_(lry,12,0),       \
                                          gF_(tile,3,24)|gF_(ulx,12,12)|      \
                                          gF_(uly,12,0))
...
# define gsSPModifyVertex(vtx,where,\
                          val)        gsMoveWd(G_MW_POINTS,(vtx)*40+(where),  \
                                               val)
# define gsSPVertex(v,n,v0)           gO_(G_VTX,gF_((n)-1,4,20)|gF_(v0,4,16)| \
                                          gF_(sizeof(Vtx)*(n),16,0),v)
#endif
...
# define gsSPForceMatrix(mptr)        gsMoveMem(16,G_MV_MATRIX_1,             \
                                      ...
                                      gsMoveMem(16,G_MV_MATRIX_2,             \
                                                (char*)(mptr)+16),            \
                                      gsMoveMem(16,G_MV_MATRIX_3,             \
                                                (char*)(mptr)+32),            \
                                      gsMoveMem(16,G_MV_MATRIX_4,             \
                                                (char*)(mptr)+48)
...
# define gsSPTexture(sc,tc,level,   \
                     tile,on)         gO_(G_TEXTURE,                          \
                                          ...
                                          gF_(on,8,0),gF_(sc,16,16)|          \
                                          gF_(tc,16,0))
# define gsSPViewport(v)              gsMoveMem(sizeof(Vp),G_MV_VIEWPORT,v)
# define                            \
gsSPSetOtherMode(opc,shift,length,  \
                 data)                gO_(opc,gF_(shift,8,8)|gF_(length,8,0), \
                                          data)
# define gsMoveWd(index,offset,data)  gO_(G_MOVEWORD,gF_(offset,16,8)|        \
                                          gF_(index,8,0),data)
# define gsMoveMem(size,index,      \
                   address)           gO_(G_MOVEMEM,gF_(index,8,16)|          \
                                          gF_(size,16,0),address)
#endif
...
gsSPBranchLessZ(branchdl,vtx,zval,  \
                near,far,flag)        gsSPBranchLessZrg(branchdl,vtx,zval,    \
                                                        near,far,flag,0,0x3FF)
# define                            \
...
# define                            \
gsSPDma_io(flag,dmem,dram,size)       gO_(G_DMA_IO,gF_(flag,1,23)|            \
                                          gF_((dmem)/8,10,13)|                \
