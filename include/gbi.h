...
#define GX_MODE_OUTLINE       0b00000100
...
#define ZMODE_OPA      (gI_(0b00) << (G_MDSFT_RENDERMODE + 7)) // TODO
...
#define GBL_c1(p, a, m, b) (gF_(p, 2, 30) | gF_(a, 2, 26) | \
	gF_(m, 2, 22) | gF_(b, 2, 18))
#define GBL_c2(p, a, m, b) (gF_(p, 2, 28) | gF_(a, 2, 24) | \
	gF_(m, 2, 20) | gF_(b, 2, 16))

/* render modes */
#define G_RM_OPA_SURF        (CVG_DST_CLAMP | ZMODE_OPA | FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_0, G_BL_CLR_IN, G_BL_1))
#define G_RM_OPA_SURF2       (CVG_DST_CLAMP | ZMODE_OPA | FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_0, G_BL_CLR_IN, G_BL_1))
#define G_RM_AA_OPA_SURF     (AA_EN | IM_RD | CVG_DST_CLAMP | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_AA_OPA_SURF2    (AA_EN | IM_RD | CVG_DST_CLAMP | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_RA_OPA_SURF     (AA_EN | CVG_DST_CLAMP | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_RA_OPA_SURF2    (AA_EN | CVG_DST_CLAMP | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
...
#define G_RM_AA_ZB_OPA_SURF  (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_AA_ZB_OPA_SURF2 (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_RA_ZB_OPA_SURF  (AA_EN | Z_CMP | Z_UPD | CVG_DST_CLAMP | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_RA_ZB_OPA_SURF2 (AA_EN | Z_CMP | Z_UPD | CVG_DST_CLAMP | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))

#define G_RM_XLU_SURF        (IM_RD | CVG_DST_FULL | ZMODE_OPA | FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_XLU_SURF2       (IM_RD | CVG_DST_FULL | ZMODE_OPA | FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_XLU_SURF     (AA_EN | IM_RD | CLR_ON_CVG | CVG_DST_WRAP | \
	ZMODE_OPA | FORCE_BL | GBL_c1( G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA \
	))
#define G_RM_AA_XLU_SURF2    (AA_EN | IM_RD | CLR_ON_CVG | CVG_DST_WRAP | \
	ZMODE_OPA | FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_ZB_XLU_SURF     (Z_CMP | IM_RD | CVG_DST_FULL | ZMODE_XLU | \
	FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_ZB_XLU_SURF2    (Z_CMP | IM_RD | CVG_DST_FULL | ZMODE_XLU | \
	FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_XLU_SURF  (AA_EN | Z_CMP | IM_RD | CLR_ON_CVG | \
	CVG_DST_WRAP | ZMODE_XLU | FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_XLU_SURF2 (AA_EN | Z_CMP | IM_RD | CLR_ON_CVG | \
	CVG_DST_WRAP | ZMODE_XLU | FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))

#define G_RM_ZB_OPA_DECAL     (Z_CMP | CVG_DST_FULL | ZMODE_DEC | \
	ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_ZB_OPA_DECAL2    (Z_CMP | CVG_DST_FULL | ZMODE_DEC | \
	ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_AA_ZB_OPA_DECAL  (AA_EN | Z_CMP | IM_RD | CVG_DST_WRAP | \
	ZMODE_DEC | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_AA_ZB_OPA_DECAL2 (AA_EN | Z_CMP | IM_RD | CVG_DST_WRAP | \
	ZMODE_DEC | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_RA_ZB_OPA_DECAL  (AA_EN | Z_CMP | CVG_DST_WRAP | ZMODE_DEC | \
	ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_RA_ZB_OPA_DECAL2 (AA_EN | Z_CMP | CVG_DST_WRAP | ZMODE_DEC | \
	ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))

#define G_RM_ZB_XLU_DECAL     (Z_CMP | IM_RD | CVG_DST_FULL | ZMODE_DEC | \
	FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_ZB_XLU_DECAL2    (Z_CMP | IM_RD | CVG_DST_FULL | ZMODE_DEC | \
	FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_XLU_DECAL  (AA_EN | Z_CMP | IM_RD | CLR_ON_CVG | \
	CVG_DST_WRAP | ZMODE_DEC | FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_XLU_DECAL2 (AA_EN | Z_CMP | IM_RD | CLR_ON_CVG | \
	CVG_DST_WRAP | ZMODE_DEC | FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))

#define G_RM_AA_ZB_OPA_INTER  (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | \
	ZMODE_INTER | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_AA_ZB_OPA_INTER2 (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | \
	ZMODE_INTER | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_RA_ZB_OPA_INTER  (AA_EN | Z_CMP | Z_UPD | CVG_DST_CLAMP | \
	ZMODE_INTER | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_RA_ZB_OPA_INTER2 (AA_EN | Z_CMP | Z_UPD | CVG_DST_CLAMP | \
	ZMODE_INTER | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))

#define G_RM_AA_ZB_XLU_INTER  (AA_EN | Z_CMP | IM_RD | CLR_ON_CVG | \
	CVG_DST_WRAP | ZMODE_INTER | FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_XLU_INTER2 (AA_EN | Z_CMP | IM_RD | CLR_ON_CVG | \
	CVG_DST_WRAP | ZMODE_INTER | FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))

#define G_RM_AA_XLU_LINE     (AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | \
	CVG_X_ALPHA | ALPHA_CVG_SEL | FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_XLU_LINE2    (AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | \
	CVG_X_ALPHA | ALPHA_CVG_SEL | FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_XLU_LINE  (AA_EN | Z_CMP | IM_RD | CVG_DST_CLAMP | \
	ZMODE_XLU | CVG_X_ALPHA | ALPHA_CVG_SEL | \
	FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_XLU_LINE2 (AA_EN | Z_CMP | IM_RD | CVG_DST_CLAMP | \
	ZMODE_XLU | CVG_X_ALPHA | ALPHA_CVG_SEL | \
	FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))

#define G_RM_AA_DEC_LINE     (AA_EN | IM_RD | CVG_DST_FULL | ZMODE_OPA | \
	CVG_X_ALPHA | ALPHA_CVG_SEL | FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_DEC_LINE2    (AA_EN | IM_RD | CVG_DST_FULL | ZMODE_OPA | \
	CVG_X_ALPHA | ALPHA_CVG_SEL | FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_DEC_LINE  (AA_EN | Z_CMP | IM_RD | CVG_DST_SAVE | \
	ZMODE_DEC | CVG_X_ALPHA | ALPHA_CVG_SEL | \
	FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_DEC_LINE2 (AA_EN | Z_CMP | IM_RD | CVG_DST_SAVE | \
	ZMODE_DEC | CVG_X_ALPHA | ALPHA_CVG_SEL | \
	FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
...
#define G_RM_AA_TEX_EDGE     (AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | \
	...
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_AA_TEX_EDGE2    (AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | \
	CVG_X_ALPHA | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_AA_ZB_TEX_EDGE  (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | \
	ZMODE_OPA | CVG_X_ALPHA | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_AA_ZB_TEX_EDGE2 (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | \
	ZMODE_OPA | CVG_X_ALPHA | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))

#define G_RM_AA_ZB_TEX_INTER  (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | \
	ZMODE_INTER | CVG_X_ALPHA | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_AA_ZB_TEX_INTER2 (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | \
	ZMODE_INTER | CVG_X_ALPHA | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))

#define G_RM_AA_SUB_SURF     (AA_EN | IM_RD | CVG_DST_FULL | ZMODE_OPA | \
	ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_AA_SUB_SURF2    (AA_EN | IM_RD | CVG_DST_FULL | ZMODE_OPA | \
	ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_AA_ZB_SUB_SURF  (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_FULL | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))
#define G_RM_AA_ZB_SUB_SURF2 (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_FULL | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM))

#define G_RM_PCL_SURF        (G_AC_DITHER | CVG_DST_FULL | ZMODE_OPA | \
	FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_0, G_BL_CLR_IN, G_BL_1))
#define G_RM_PCL_SURF2       (G_AC_DITHER | CVG_DST_FULL | ZMODE_OPA | \
	FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_0, G_BL_CLR_IN, G_BL_1))
#define G_RM_AA_PCL_SURF     (G_AC_DITHER | AA_EN | IM_RD | CVG_DST_CLAMP | \
	ZMODE_OPA | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_PCL_SURF2    (G_AC_DITHER | AA_EN | IM_RD | CVG_DST_CLAMP | \
	ZMODE_OPA | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_ZB_PCL_SURF     (G_AC_DITHER | Z_CMP | Z_UPD | CVG_DST_FULL | \
	ZMODE_OPA | \
	GBL_c1(G_BL_CLR_IN, G_BL_0, G_BL_CLR_IN, G_BL_1))
#define G_RM_ZB_PCL_SURF2    (G_AC_DITHER | Z_CMP | Z_UPD | CVG_DST_FULL | \
	ZMODE_OPA | \
	GBL_c2(G_BL_CLR_IN, G_BL_0, G_BL_CLR_IN, G_BL_1))
#define G_RM_AA_ZB_PCL_SURF  (G_AC_DITHER | AA_EN | Z_CMP | Z_UPD | IM_RD | \
	CVG_DST_CLAMP | ZMODE_OPA | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_PCL_SURF2 (G_AC_DITHER | AA_EN | Z_CMP | Z_UPD | IM_RD | \
	CVG_DST_CLAMP | ZMODE_OPA | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))

#define G_RM_AA_OPA_TERR     (AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | \
	ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_OPA_TERR2    (AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | \
	ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_OPA_TERR  (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_OPA_TERR2 (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))

#define G_RM_AA_TEX_TERR     (AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | \
	CVG_X_ALPHA | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_TEX_TERR2    (AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | \
	CVG_X_ALPHA | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_TEX_TERR  (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | \
	ZMODE_OPA | CVG_X_ALPHA | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_TEX_TERR2 (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | \
	ZMODE_OPA | CVG_X_ALPHA | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))

#define G_RM_AA_SUB_TERR     (AA_EN | IM_RD | CVG_DST_FULL | ZMODE_OPA | \
	ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_SUB_TERR2    (AA_EN | IM_RD | CVG_DST_FULL | ZMODE_OPA | \
	ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_SUB_TERR  (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_FULL | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_AA_ZB_SUB_TERR2 (AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_FULL | \
	ZMODE_OPA | ALPHA_CVG_SEL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))

#define G_RM_CLD_SURF     (IM_RD | CVG_DST_SAVE | ZMODE_OPA | FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_CLD_SURF2    (IM_RD | CVG_DST_SAVE | ZMODE_OPA | FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_ZB_CLD_SURF  (Z_CMP | IM_RD | CVG_DST_SAVE | ZMODE_XLU | \
	FORCE_BL | \
	GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
#define G_RM_ZB_CLD_SURF2 (Z_CMP | IM_RD | CVG_DST_SAVE | ZMODE_XLU | \
	FORCE_BL | \
	GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA))
...
#define G_RM_ADD2 (IM_RD | CVG_DST_SAVE | ZMODE_OPA | \
	FORCE_BL | \
...
#define G_CC_BLENDI                 ENVIRONMENT, SHADE, TEXEL0, SHADE, \
	0, 0, 0, SHADE
#define G_CC_BLENDIA                ENVIRONMENT, SHADE, TEXEL0, SHADE, \
	TEXEL0, 0, SHADE, 0
#define G_CC_BLENDIDECALA           ENVIRONMENT, SHADE, TEXEL0, SHADE, \
	0, 0, 0, TEXEL0
#define G_CC_BLENDRGBA              TEXEL0, SHADE, TEXEL0_ALPHA, SHADE, \
	0, 0, 0, SHADE
#define G_CC_BLENDRGBDECALA         TEXEL0, SHADE, TEXEL0_ALPHA, SHADE, \
	0, 0, 0, TEXEL0
#define G_CC_REFLECTRGB             ENVIRONMENT, 0, TEXEL0, SHADE, 0, 0, 0, SHADE
#define G_CC_REFLECTRGBDECALA       ENVIRONMENT, 0, TEXEL0, SHADE, 0, 0, 0, TEXEL0
#define G_CC_HILITERGB              PRIMITIVE, SHADE, TEXEL0, SHADE, \
	0, 0, 0, SHADE
#define G_CC_HILITERGBA             PRIMITIVE, SHADE, TEXEL0, SHADE, \
	PRIMITIVE, SHADE, TEXEL0, SHADE
#define G_CC_HILITERGBDECALA        PRIMITIVE, SHADE, TEXEL0, SHADE, \
	0, 0, 0, TEXEL0
...
#define G_CC_BLENDPE                PRIMITIVE, ENVIRONMENT, TEXEL0, \
	ENVIRONMENT, TEXEL0, 0, SHADE, 0
#define G_CC_BLENDPEDECALA          PRIMITIVE, ENVIRONMENT, TEXEL0, \
	ENVIRONMENT, 0, 0, 0, TEXEL0
#define G_CC_TRILERP                TEXEL1, TEXEL0, LOD_FRACTION, TEXEL0, \
...
#define G_CC_MODULATEIA_PRIM2       COMBINED, 0, PRIMITIVE, 0, \
...
#define G_CC_BLENDI2                ENVIRONMENT, SHADE, COMBINED, SHADE, \
	0, 0, 0, SHADE
#define G_CC_BLENDIA2               ENVIRONMENT, SHADE, COMBINED, SHADE, \
	COMBINED, 0, SHADE, 0
#define G_CC_HILITERGB2             ENVIRONMENT, COMBINED, TEXEL0, COMBINED, \
	0, 0, 0, SHADE
#define G_CC_HILITERGBA2            ENVIRONMENT, COMBINED, TEXEL0, COMBINED, \
	ENVIRONMENT, COMBINED, TEXEL0, COMBINED
#define G_CC_HILITERGBDECALA2       ENVIRONMENT, COMBINED, TEXEL0, COMBINED, \
	0, 0, 0, TEXEL0
#define G_CC_HILITERGBPASSA2        ENVIRONMENT, COMBINED, TEXEL0, COMBINED, \
	0, 0, 0, COMBINED
...
extern uintptr_t __n64_pointer__;
...
#define gdSPDefLights3(ar, ag, ab, \
		r1, g1, b1, x1, y1, z1, \
		r2, g2, b2, x2, y2, z2, \
		r3, g3, b3, x3, y3, z3)    ((GbiLights3) \
	{ { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, \
	  { { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, \
			{ x1, y1, z1 }, 0 } }, \
		{ { { r2, g2, b2 }, 0, { r2, g2, b2 }, 0, \
			{ x2, y2, z2 }, 0 } }, \
		{ { { r3, g3, b3 }, 0, { r3, g3, b3 }, 0, \
			{ x3, y3, z3 }, 0 } } } })
#define gdSPDefLights4(ar, ag, ab, \
		r1, g1, b1, x1, y1, z1, \
		r2, g2, b2, x2, y2, z2, \
		r3, g3, b3, x3, y3, z3, \
		r4, g4, b4, x4, y4, z4)    ((GbiLights4) \
	{ { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, \
	  { { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, \
			{ x1, y1, z1 }, 0 } }, \
		{ { { r2, g2, b2 }, 0, { r2, g2, b2 }, 0, \
...
#define gdSPDefLights7(ar, ag, ab, \
	...
	{ { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, \
	  { { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, \
		...
		{ { { r6, g6, b6 }, 0, { r6, g6, b6 }, 0, \
			{ x6, y6, z6 }, 0 } }, \
		{ { { r7, g7, b7 }, 0, { r7, g7, b7 }, 0, \
			{ x7, y7, z7 }, 0 } } } })
#define gdSPDefVtx(x, y, z, s, t)  ((GbiVtx) \
	{ .v = { { x, y, z }, 0, { qs105(s), qs105(t) } } })
#define gdSPDefVtxC(x, y, z, s, t, \
		r, g, b, a)                ((GbiVtx) \
	{ .v = { { x, y, z }, 0, { qs105(s), qs105(t) }, \
			 { r, g, b, a} } })
#define gdSPDefVtxN(x, y, z, s, t, \
		nx, ny, nz, a)             ((GbiVtx) \
	{ .n = { { x,  y,  z  }, 0, { qs105(s), qs105(t) }, \
			 { nx, ny, nz }, a } })

/* instruction macros */
#define gsDPFillRectangle(ulx, uly, lrx, lry) gO_( \
		G_FILLRECT, \
		gF_(lrx, 10, 14) | gF_(lry, 10, 2), \
		gF_(ulx, 10, 14) | gF_(uly, 10, 2) \
)
#define gsDPScisFillRectangle(ulx, uly, lrx, \
		lry)                                  gsDPFillRectangle( \
		(ulx)<0?0:(ulx), \
		(uly)<0?0:(uly), \
		(lrx)<0?0:(lrx), \
		(lry)<0?0:(lry) \
...
#define gsDPLoadTLUT_pal16(pal, dram)         gsDPLoadTLUT( \
		16, \
		256 + (gI_(pal) & 0xF) * 16, \
		dram \
)
...
#define gLTB_(timg, fmt, siz, width, height, pal, \
		cms, cmt, masks, maskt, \
		shifts, shiftt, dxt, tmem, rt, line)  gsDPSetTextureImage( \
		fmt, \
		G_SIZ_LDSIZ(siz), \
		1, \
		timg \
...
#define gsDPLoadTextureBlock(timg, fmt, siz, \
		width, height, \
		pal, cms, cmt, \
		masks, maskt, \
		shifts, shiftt)                       gLTB_( \
...
#define gsDPLoadTextureBlockS(timg, fmt, siz, \
		width, height, \
		pal, cms, cmt, \
		masks, maskt, \
		shifts, shiftt)                       gLTB_( \
...
#define gsDPLoadTextureBlock_4b(timg, fmt, \
		width, \
		height, pal, \
		cms, cmt, \
		masks, \
...
#define gsDPLoadTextureBlock_4bS(timg, fmt, \
		width, \
		height, pal, \
		cms, cmt, \
		masks, \
...
#define gsDPLoadTextureBlockYuv(timg, fmt, \
		siz, \
		width, \
		height, \
		pal, \
...
#define  gsDPLoadTextureBlockYuvS(timg, fmt, \
		siz, \
		width, \
		height, \
		pal, \
...
#define _gsDPLoadTextureBlock(timg, tmem, \
		fmt, siz, \
		width, height, \
		pal, cms, cmt, \
		masks, maskt, \
...
#define _gsDPLoadTextureBlockS(timg, tmem, \
		fmt, siz, \
		width, height, \
		pal, cms, cmt, \
		masks, maskt, \
...
#define _gsDPLoadTextureBlock_4b(timg, tmem, \
		fmt, width, \
		height, pal, \
		cms, cmt, \
		masks, \
...
#define _gsDPLoadTextureBlock_4bS(timg, tmem, \
		fmt, width, \
		height, \
		pal, cms, \
		cmt, masks, \
...
#define _gsDPLoadTextureBlockYuv(timg, tmem, \
		fmt, siz, \
		width, \
		height, pal, \
		cms, cmt, \
...
#define _gsDPLoadTextureBlockYuvS(timg, tmem, \
		fmt, siz, \
		width, \
		height, \
		pal, \
...
#define gsDPLoadMultiBlock(timg, tmem, rt, \
		fmt, siz, \
		width, height, \
		pal, cms, cmt, \
		masks, maskt, \
...
#define gsDPLoadMultiBlockS(timg, tmem, rt, \
		fmt, siz, \
		width, height, \
		pal, cms, cmt, \
		masks, maskt, \
...
#define gsDPLoadMultiBlock_4b(timg, tmem, rt, \
		fmt, \
		width, height, \
		pal, cms, cmt, \
		masks, maskt, \
...
#define gsDPLoadMultiBlock_4bS(timg, tmem, rt, \
		fmt, \
		width, height, \
		pal, cms, cmt, \
		masks, maskt, \
...
#define gsDPLoadMultiBlockYuv(timg, tmem, rt, \
		fmt, siz, \
		width, height, \
		pal, cms, cmt, \
		masks, maskt, \
...
#define gsDPLoadMultiBlockYuvS(timg, tmem, rt, \
		fmt, siz, \
		width, height, \
		pal, cms, cmt, \
		masks, maskt, \
...
#define gLTT_(timg, fmt, siz, width, height, \
...
#define gLTT4_(timg, fmt, width, height, \
		uls, ult, lrs, lrt, pal, cms, cmt, \
		masks, maskt, shifts, shiftt, \
		tmem, rt)                             gsDPSetTextureImage( \
		fmt, \
		G_IM_SIZ_8b, \
		(width) / 2, \
		timg \
...
#define gsDPLoadTextureTile(timg, fmt, siz, \
		width, height, \
		uls, ult, lrs, \
		lrt, pal, cms, \
		cmt, masks, \
...
#define gsDPLoadTextureTile_4b(timg, fmt, \
		width, \
		height, uls, \
		ult, lrs, lrt, \
		pal, cms, cmt, \
		masks, maskt, \
		shifts, shiftt)                       gLTT4_( \
		timg, \
		fmt, \
		width, \
		height, \
...
#define gsDPLoadTextureTileYuv(timg, fmt, siz, \
		width, height, \
		uls, ult, lrs, \
		lrt, pal, cms, \
		cmt, masks, \
...
#define _gsDPLoadTextureTile(timg, tmem, \
		fmt, siz, \
		width, height, \
		uls, ult, lrs, \
		lrt, pal, cms, \
...
#define _gsDPLoadTextureTile_4b(timg, tmem, \
		fmt, width, \
		height, uls, \
		ult, lrs, lrt, \
		pal, cms, cmt, \
...
#define _gsDPLoadTextureTileYuv(timg, tmem, \
		fmt, siz, \
		width, \
		height, uls, \
		ult, lrs, lrt, \
...
#define gsDPLoadMultiTile(timg, tmem, rt, \
		fmt, siz, \
		width, height, \
		uls, ult, lrs, lrt, \
		pal, cms, cmt, \
...
#define gsDPLoadMultiTile_4b(timg, tmem, rt, \
		fmt, width, \
		height, uls, ult, \
		lrs, lrt, pal, \
		cms, cmt, \
...
#define gsDPLoadMultiTileYuv(timg, tmem, rt, \
		fmt, siz, width, \
		height, uls, ult, \
		lrs, lrt, pal, \
		cms, cmt, \
...
#define gsDPPipelineMode(mode)                gsSPSetOtherModeHi( \
		G_MDSFT_PIPELINE, \
		G_MDSIZ_PIPELINE, \
		mode \
)
#define gsDPSetBlendColor(r, g, b, a)         gO_( \
		G_SETBLENDCOLOR, \
		0, \
		gF_(r, 8, 24) | gF_(g, 8, 16) | \
		gF_(b, 8, 8) | gF_(a, 8, 0) \
)
#define gsDPSetEnvColor(r, g, b, a)           gO_( \
		G_SETENVCOLOR, \
		0, \
		gF_(r, 8, 24) | gF_(g, 8, 16) | \
		gF_(b, 8, 8) | gF_(a, 8, 0) \
...
#define gsDPSetFogColor(r, g, b, a)           gO_( \
		G_SETFOGCOLOR, \
		0, \
		gF_(r, 8, 24) | gF_(g, 8, 16) | \
		gF_(b, 8, 8) | gF_(a, 8, 0) \
)
#define gsDPSetPrimColor(m, l, r, g, b, a)    gO_( \
		G_SETPRIMCOLOR, \
		gF_(m, 8, 8) | gF_(l, 8, 0), \
		gF_(r, 8, 24) | gF_(g, 8, 16) | \
		gF_(b, 8, 8) | gF_(a, 8, 0) \
)
#define gsDPSetColorImage(fmt, siz, width, \
		img)                                  gO_( \
		G_SETCIMG, \
		gF_(fmt, 3, 21) | \
		gF_(siz, 2, 19) | \
...
#define gsDPSetTextureImage(fmt, siz, width, \
		img)                                  gO_( \
		G_SETTIMG, \
		gF_(fmt, 3, 21) | \
		gF_(siz, 2, 19) | \
...
#define gsDPSetHilite1Tile(tile, hilite, \
		width, height)                        gsDPSetTileSize( \
		tile, \
		((GbiHilite*)(hilite))-> \
		h.x1 & 0xFFF, \
		((GbiHilite*)(hilite))-> \
...
#define gsDPSetHilite2Tile(tile, hilite, \
		width, height)                        gsDPSetTileSize( \
		tile, \
		((GbiHilite*)(hilite))-> \
		h.x2 & 0xFFF, \
...
#define gsDPSetAlphaCompare(mode)             gsSPSetOtherModeLo( \
		G_MDSFT_ALPHACOMPARE, \
		G_MDSIZ_ALPHACOMPARE, \
		mode \
)
#define gsDPSetAlphaDither(type)              gsSPSetOtherModeHi( \
		G_MDSFT_ALPHADITHER, \
		G_MDSIZ_ALPHADITHER, \
		type \
)
#define gsDPSetColorDither(type)              gsSPSetOtherModeHi( \
		G_MDSFT_RGBDITHER, \
		G_MDSIZ_RGBDITHER, \
		type \
)
#define gsDPSetCombineMode(mode1, \
		mode2)                                gsDPSetCombineLERP(mode1, mode2)
#define gsDPSetCombineLERP(a0, b0, c0, d0, Aa0, \
		Ab0, Ac0, Ad0, a1, \
		b1, c1, d1, Aa1, \
		Ab1, Ac1, Ad1)                        gO_( \
		G_SETCOMBINE, \
...
#define gsDPSetConvert(k0, k1, k2, \
		...
		gF_(k4, 9, 9) | gF_(k5, 9, 0) \
)
#define gsDPSetTextureConvert(type)           gsSPSetOtherModeHi( \
		G_MDSFT_TEXTCONV, \
		G_MDSIZ_TEXTCONV, \
		type \
)
#define gsDPSetCycleType(type)                gsSPSetOtherModeHi( \
		G_MDSFT_CYCLETYPE, \
		G_MDSIZ_CYCLETYPE, \
		type \
)
#define gsDPSetDepthSource(source)            gsSPSetOtherModeLo( \
		G_MDSFT_ZSRCSEL, \
		G_MDSIZ_ZSRCSEL, \
		source \
)
#define gsDPSetCombineKey(type)               gsSPSetOtherModeHi( \
		G_MDSFT_COMBKEY, \
		G_MDSIZ_COMBKEY, \
		type \
)
...
#define gsDPSetKeyR(cR, sR, wR)               gO_( \
		G_SETKEYR, \
		0, \
		gF_(wR, 12, 16) | gF_(cR, 8, 8) | \
		gF_(sR, 8, 0) \
)
#define gsDPSetPrimDepth(z, dz)               gO_( \
		G_SETPRIMDEPTH, \
		0, \
		gF_(z, 16, 16) | gF_(dz, 16, 0) \
)
#define gsDPSetRenderMode(mode1, \
		mode2)                                gsSPSetOtherModeLo( \
		G_MDSFT_RENDERMODE, \
		G_MDSIZ_RENDERMODE, \
		gI_(mode1) | gI_(mode2) \
)
#define gsDPSetScissor(mode, ulx, \
		uly, lrx, lry)                        gsDPSetScissorFrac( \
		mode, \
		qu102(gI_(ulx)), \
		qu102(gI_(uly)), \
		qu102(gI_(lrx)), \
...
#define gsDPSetScissorFrac(mode, \
		ulx, uly, lrx, lry)                   gO_( \
		G_SETSCISSOR, \
...
#define gsDPSetTextureDetail(type)            gsSPSetOtherModeHi( \
		G_MDSFT_TEXTDETAIL, \
		G_MDSIZ_TEXTDETAIL, \
		type \
)
#define gsDPSetTextureFilter(mode)            gsSPSetOtherModeHi( \
		G_MDSFT_TEXTFILT, \
		G_MDSIZ_TEXTFILT, \
		mode \
)
#define gsDPSetTextureLOD(mode)               gsSPSetOtherModeHi( \
		G_MDSFT_TEXTLOD, \
		G_MDSIZ_TEXTLOD, \
		mode \
)
#define gsDPSetTextureLUT(mode)               gsSPSetOtherModeHi( \
		G_MDSFT_TEXTLUT, \
		G_MDSIZ_TEXTLUT, \
		mode \
)
#define gsDPSetTexturePersp(enable)           gsSPSetOtherModeHi( \
		G_MDSFT_TEXTPERSP, \
		G_MDSIZ_TEXTPERSP, \
		enable \
)
#define gsDPSetTile(fmt, siz, line, tmem, \
		tile, palette, cmt, \
...
#define gsSPClipRatio(r)                      gsMoveWd( \
		G_MW_CLIP, \
		G_MWO_CLIP_RNX, \
		(uint16_t)(r) \
), \
...
#define gsSPFogPosition(min, max)             gsMoveWd( \
		G_MW_FOG, \
		G_MWO_FOG, \
		gF_( \
			128000 / ((max) - (min)), \
...
#define gsSPSetLights0(lites)                 gsSPNumLights(NUMLIGHTS_0), \
	...
	gsSPLight(&(lites).a, 2)
#define gsSPSetLights1(lites)                 gsSPNumLights(NUMLIGHTS_1), \
	gsSPLight(&(lites).l[0], 1), \
	gsSPLight(&(lites).a, 2)
#define gsSPSetLights2(lites)                 gsSPNumLights(NUMLIGHTS_2), \
	gsSPLight(&(lites).l[0], 1), \
	gsSPLight(&(lites).l[1], 2), \
	gsSPLight(&(lites).a, 3)
#define gsSPSetLights3(lites)                 gsSPNumLights(NUMLIGHTS_3), \
	gsSPLight(&(lites).l[0], 1), \
	gsSPLight(&(lites).l[1], 2), \
	gsSPLight(&(lites).l[2], 3), \
	gsSPLight(&(lites).a, 4)
#define gsSPSetLights4(lites)                 gsSPNumLights(NUMLIGHTS_4), \
	gsSPLight(&(lites).l[0], 1), \
	gsSPLight(&(lites).l[1], 2), \
	gsSPLight(&(lites).l[2], 3), \
	gsSPLight(&(lites).l[3], 4), \
	gsSPLight(&(lites).a, 5)
#define gsSPSetLights5(lites)                 gsSPNumLights(NUMLIGHTS_5), \
	gsSPLight(&(lites).l[0], 1), \
	gsSPLight(&(lites).l[1], 2), \
	gsSPLight(&(lites).l[2], 3), \
	gsSPLight(&(lites).l[3], 4), \
	...
	gsSPLight(&(lites).a, 6)
#define gsSPSetLights6(lites)                 gsSPNumLights(NUMLIGHTS_6), \
	gsSPLight(&(lites).l[0], 1), \
	gsSPLight(&(lites).l[1], 2), \
	gsSPLight(&(lites).l[2], 3), \
	gsSPLight(&(lites).l[3], 4), \
	...
	gsSPLight(&(lites).a, 7)
#define gsSPSetLights7(lites)                 gsSPNumLights(NUMLIGHTS_7), \
	gsSPLight(&(lites).l[0], 1), \
	gsSPLight(&(lites).l[1], 2), \
	gsSPLight(&(lites).l[2], 3), \
	gsSPLight(&(lites).l[3], 4), \
...
#define gsSPNumLights(n)                      gsMoveWd( \
		G_MW_NUMLIGHT, \
		G_MWO_NUMLIGHT, \
		NUML(n) \
)
#define gsSPLightColor(Lightnum, \
		packedcolor)                          gsMoveWd( \
		G_MW_LIGHTCOL, \
		G_MWO_a ## Lightnum, \
		packedcolor \
), \
...
#define gsSPTextureRectangle(ulx, uly, lrx, \
		lry, tile, s, t, \
		dsdx, dtdy)                           gsTexRect(ulx, uly, lrx, lry, tile), \
	gsDPHalf1(gF_(s, 16, 16) | gF_(t, 16, 0)), \
	gsDPHalf2(gF_(dsdx, 16, 16) | gF_(dtdy, 16, 0))
#define gsSPScisTextureRectangle(ulx, uly, \
		lrx, lry, \
		tile, s, t, \
		dsdx, dtdy)                           gsTexRect( \
		(ulx)<0?0:(ulx), \
	...
	gsDPHalf2(gF_(dsdx, 16, 16) | gF_(dtdy, 16, 0))
#define gsSPTextureRectangleFlip(ulx, uly, \
		lrx, lry, \
		tile, s, t, \
		dsdx, dtdy)                           gsTexRectFlip(ulx, uly, lrx, lry, tile), \
	gsDPHalf1(gF_(s, 16, 16) | gF_(t, 16, 0)), \
	gsDPHalf2(gF_(dsdx, 16, 16) | gF_(dtdy, 16, 0))
#define gsSPScisTextureRectangleFlip(ulx, \
		uly, \
		lrx, \
		lry, \
		tile, \
...
#define gsSPObjMatrix(mtx)                    gO_( \
		G_OBJ_MOVEMEM, \
		gF_(sizeof(GbiObjMtx) - 1, 8, 16), \
		mtx \
)
#define gsSPObjSubMatrix(mtx)                 gO_( \
		G_OBJ_MOVEMEM, \
		gF_(sizeof(GbiObjSubMtx) - 1, 8, 16) | \
		gF_(2, 16, 0), \
		mtx \
)
...
#define gsDPLoadTLUTCmd(tile, count)    gO_( \
		G_LOADTLUT, \
		0, \
		gF_(tile, 3, 24) | \
		gF_(count, 10, 14) \
)
#define gsDPLoadTLUT(count, tmem, dram) gsDPSetTextureImage( \
		G_IM_FMT_RGBA, \
		G_IM_SIZ_16b, \
		1, \
		dram \
...
#define gsDisplayList(dl, branch) \
	gsGeneric(dl), \
	gO_(G_DL, gF_(branch, 8, 16), __n64_pointer__ & 0xffffffff)
...
#define gsDPSetOtherMode(mode0, mode1)          gO_( \
		G_RDPSETOTHERMODE, \
		gF_(mode0, 24, 0), \
		mode1 \
)
#define gsTexRect(ulx, uly, lrx, lry, tile)     gO_( \
		G_TEXRECT, \
		gF_(lrx, 12, 12) | gF_(lry, 12, 0), \
		gF_(tile, 3, 24) | gF_(ulx, 12, 12) | \
		gF_(uly, 12, 0) \
)
#define gsTexRectFlip(ulx, uly, lrx, lry, tile) gO_( \
		G_TEXRECTFLIP, \
		gF_(lrx, 12, 12) | gF_(lry, 12, 0), \
		gF_(tile, 3, 24) | gF_(ulx, 12, 12) | \
		gF_(uly, 12, 0) \
...
/* instruction macros for fast3d */
#if defined(F3D_GBI)
	#define gsSP1Triangle(v0, v1, v2, flag) gO_( \
			G_TRI1, \
			0, \
			gF_(flag, 8, 24) | \
			gF_(gI_(v0) * 10, 8, 16) | \
	...
	#define gsSPCullDisplayList(v0, vn)     gO_( \
			G_CULLDL, \
			((v0) & 0xF) * 40, \
			(((vn) + 1) & 0xF) * 40 \
	)
	#define gsSPLineW3D(v0, v1, wd, flag)   gO_( \
			G_LINE3D, \
			0, \
			gF_(flag, 8, 24) | \
			gF_(gI_(v0) * 10, 8, 16) | \
	...
	#define gsSPVertex(v, n, v0)            gO_( \
			G_VTX, \
			gF_((n) - 1, 4, 20) | gF_(v0, 4, 16) | \
			gF_(sizeof(GbiVtx) * (n), 16, 0), \
			v \
	)
#endif
...
/* instruction macros for fast3d and f3dex */
	...
	#define gsSPLookAtX(l)                gsMoveMem(sizeof(GbiLight), G_MV_LOOKATX, l)
	#define gsSPLookAtY(l)                gsMoveMem(sizeof(GbiLight), G_MV_LOOKATY, l)
	#define gsSPMatrix(matrix, param)     gsGeneric(matrix), gO_( \
			G_MTX, \
			gF_(param, 8, 16) | \
			gF_(sizeof(int32_t[4][4]), 16, 0), \
			(__n64_pointer__) & 0xffffffff \
	)
	...
	#define gsSPViewport(v)               gsMoveMem(sizeof(GbiVp), G_MV_VIEWPORT, v)
	#define gsSPSetOtherMode(opc, shift, length, \
			data)                         gO_( \
			opc, \
			gF_(shift, 8, 8) | gF_(length, 8, 0), \
			data \
	)
	#define gsMoveWd(index, offset, data) gO_( \
			G_MOVEWORD, \
			gF_(offset, 16, 8) | \
			gF_(index, 8, 0), \
			data \
...
/* instruction macros for f3dex */
	...
	#define gsSP1Quadrangle(v0, v1, v2, v3, flag) gO_( \
			G_TRI2, \
			gF_( \
				((flag)==0?gI_(v0): \
				(flag)==1?gI_(v1): \
	...
	#define gsSPVertex(v, n, v0)                  gO_( \
			G_VTX, \
			gF_((v0) * 2, 8, 16) | gF_(n, 6, 10) | \
			gF_(sizeof(GbiVtx) * (n) - 1, 10, 0), \
			v \
	)
#endif
...
/* instruction macros for f3dex and f3dex2 */
#if defined(F3DEX_GBI) || defined(F3DEX_GBI_2)
	#define gsSP2Triangles(v00, v01, v02, flag0, \
			v10, v11, v12, flag1)           gO_( \
			G_TRI2, \
			gF_( \
				((flag0)==0?gI_(v00): \
				(flag0)==1?gI_(v01): \
	...
	#define gsSPBranchLessZ(branchdl, vtx, zval, \
			near, far, flag)                gsSPBranchLessZrg( \
			branchdl, \
			vtx, \
			zval, \
			near, \
	...
	#define gsSPBranchLessZrg(branchdl, vtx, \
			zval, near, far, \
	...
	#define gsLoadUcode(uc_start, uc_dsize) gO_( \
			G_LOAD_UCODE, \
			gF_((uc_dsize) - 1, 16, 0), \
			uc_start \
	)
	#define gsSPLoadUcodeEx(uc_start, uc_dstart, \
...
/* instruction macros for f3dex2 */
	...
	#define gsSPLookAtY(l)                        gsMoveMem( \
			sizeof(GbiLight), \
			G_MV_LIGHT, \
			G_MVO_LOOKATY, \
			l \
	...
	#define gsSPMatrix(matrix, param)             gsGeneric(matrix), gO_( \
			...
			((uintptr_t)__n64_pointer__) & 0xffffffff \
	)
	...
	#define gsSPViewport(v)                       gsMoveMem(sizeof(GbiVp), G_MV_VIEWPORT, 0, v)
	...
	#define gsSPDma_io(flag, dmem, dram, size)    gO_( \
			G_DMA_IO, \
			gF_(flag, 1, 23) | \
			gF_((dmem) / 8, 10, 13) | \
			gF_((size) - 1, 12, 0), \
...
#define gDisplayListAppend(pgdl, ...)      ({ GbiGfx Gdl__[] = { __VA_ARGS__ }; \
											  for (size_t Gi__ = 0; Gi__<sizeof(Gdl__) / \
											  sizeof(*Gdl__); ++Gi__) \
											  *(*(GbiGfx**)(pgdl)) ++ = Gdl__[Gi__]; \
											  (void)0; })
#define gDisplayListData(pgdl, d)          (*(GbiGfx**)(pgdl) -= (sizeof(d) + \
	sizeof(GbiGfx) - 1) / sizeof(GbiGfx), \
	(__typeof__(&(d))) \
	memcpy(*(GbiGfx**)(pgdl), &(d), sizeof(d)))
#define gDisplayListAlloc(pgdl, s)         ((void*)(*(GbiGfx**)(pgdl) -= \
	((s) + sizeof(GbiGfx) - 1) / sizeof(GbiGfx)))
...
#define gDPLoadTextureBlockS(gdl, ...)     gD_( \
		gdl, \
		gsDPLoadTextureBlockS, \
		__VA_ARGS__ \
)
#define gDPLoadTextureBlock_4b(gdl, ...)   gD_( \
		gdl, \
		gsDPLoadTextureBlock_4b, \
		__VA_ARGS__ \
)
#define gDPLoadTextureBlock_4bS(gdl, ...)  gD_( \
		gdl, \
		gsDPLoadTextureBlock_4bS, \
		__VA_ARGS__ \
)
#define gDPLoadTextureBlockYuv(gdl, ...)   gD_( \
		gdl, \
		gsDPLoadTextureBlockYuv, \
		__VA_ARGS__ \
)
#define gDPLoadTextureBlockYuvS(gdl, ...)  gD_( \
		gdl, \
		gsDPLoadTextureBlockYuvS, \
		__VA_ARGS__ \
)
#define _gDPLoadTextureBlock(gdl, ...)     gD_( \
		gdl, \
		_gsDPLoadTextureBlock, \
		__VA_ARGS__ \
)
#define _gDPLoadTextureBlockS(gdl, ...)    gD_( \
		gdl, \
		_gsDPLoadTextureBlockS, \
		__VA_ARGS__ \
)
#define _gDPLoadTextureBlock_4b(gdl, ...)  gD_( \
		gdl, \
		_gsDPLoadTextureBlock_4b, \
		__VA_ARGS__ \
)
#define _gDPLoadTextureBlock_4bS(gdl, ...) gD_( \
		gdl, \
		_gsDPLoadTextureBlock_4bS, \
		__VA_ARGS__ \
)
#define _gDPLoadTextureBlockYuv(gdl, ...)  gD_( \
		gdl, \
		_gsDPLoadTextureBlockYuv, \
		__VA_ARGS__ \
)
#define _gDPLoadTextureBlockYuvS(gdl, ...) gD_( \
		gdl, \
...
#define gDPLoadMultiBlock_4b(gdl, ...)     gD_( \
		gdl, \
		gsDPLoadMultiBlock_4b, \
		__VA_ARGS__ \
)
#define gDPLoadMultiBlock_4bS(gdl, ...)    gD_( \
		gdl, \
		gsDPLoadMultiBlock_4bS, \
		__VA_ARGS__ \
)
#define gDPLoadMultiBlockYuv(gdl, ...)     gD_( \
		gdl, \
		gsDPLoadMultiBlockYuv, \
		__VA_ARGS__ \
)
#define gDPLoadMultiBlockYuvS(gdl, ...)    gD_( \
		gdl, \
		gsDPLoadMultiBlockYuvS, \
		__VA_ARGS__ \
)
#define gDPLoadTextureTile(gdl, ...)       gD_(gdl, gsDPLoadTextureTile, __VA_ARGS__)
#define gDPLoadTextureTile_4b(gdl, ...)    gD_( \
		gdl, \
		gsDPLoadTextureTile_4b, \
		__VA_ARGS__ \
)
#define gDPLoadTextureTileYuv(gdl, ...)    gD_( \
		gdl, \
		gsDPLoadTextureTileYuv, \
		__VA_ARGS__ \
)
#define _gDPLoadTextureTile(gdl, ...)      gD_( \
		gdl, \
		_gsDPLoadTextureTile, \
		__VA_ARGS__ \
)
#define _gDPLoadTextureTile_4b(gdl, ...)   gD_( \
		gdl, \
		_gsDPLoadTextureTile_4b, \
		__VA_ARGS__ \
)
#define _gDPLoadTextureTileYuv(gdl, ...)   gD_( \
		gdl, \
...
#define gSPScisTextureRectangle(gdl, ...)     gD_( \
		gdl, \
		gsSPScisTextureRectangle, \
		__VA_ARGS__ \
)
#define gSPTextureRectangleFlip(gdl, ...)     gD_( \
		gdl, \
		gsSPTextureRectangleFlip, \
		__VA_ARGS__ \
)
#define gSPScisTextureRectangleFlip(gdl, ...) gD_( \
		gdl, \
		gsSPScisTextureRectangleFlip, \
		__VA_ARGS__ \
)
...
#define gO_(opc, hi, lo) ((GbiGfx) { gF_(opc, 8, 24) | gI_(hi), gI_(lo) })
#define gD_(gdl, m, ...) gDisplayListPut(gdl, m(__VA_ARGS__))

#define gDisplayListPut(p_post_incr, ...) \
	({ \
		GbiGfx g[] = { __VA_ARGS__ }; \
		for (uint32_t i = 0; i < N64_ARRAY_COUNT(g); i++) { \
			*(GbiGfx*)(p_post_incr) = g[i]; \
		} \
		(void)0; \
	})
